        ...
        <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        <label for="email-moniteur-club">Adresse courriel <span class="text-danger">*</span></label>
                        <input class="form-control" id="email-moniteur-club" data-input-mask='{"mask":"/^\S*@?\S*$/"}'
        ...
        async function addMoniteur() {
            try {
                const requiredFields = [
                    "nom", "prenom", "cin", "email-moniteur-club", "password",
                ...
                formData.append("email", document.getElementById("email-moniteur-club").value);
                ...
                if (res.status === 200) {
                    ...
                    document.getElementById("email-moniteur-club").value = "";
