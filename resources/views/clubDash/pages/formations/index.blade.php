    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="{{ route('formations.create') }}" role="button" class="btn btn-outline-primary">
        ...
        <div class="accordion border rounded overflow-hidden" id="accordionFaq">
            ...
            <div class="card shadow-none rounded-bottom-0 border-bottom">
                <div class="accordion-item border-0">
                    <div class="card-header p-0" id="faqAccordionHeading{{ $niveau->id }}">
                        <button
                            ...
                            data-bs-toggle="collapse" data-bs-target="#collapseFaqAccordion{{ $niveau->id }}"
                            aria-expanded="false" aria-controls="collapseFaqAccordion{{ $niveau->id }}"><svg
                            ...
                            <span class="fw-medium font-sans-serif text-900">{{ $niveau->label }}</span></button>
                    </div>
                    <div class="accordion-collapse collapse" id="collapseFaqAccordion{{ $niveau->id }}"
                        aria-labelledby="faqAccordionHeading{{ $niveau->id }}" data-parent="#accordionFaq">
                        <div class="accordion-body p-0">
                            <div class="card-body bg-light tab-pane active show" id="timeline" role="tabpanel"
                                ...
                                <div class="timeline-vertical py-0">
                                    @foreach ($niveau->formations as $formation)
                                    <div class="timeline-item {{ $loop->index % 2 == 0 ? 'timeline-item-start' : 'timeline-item-end' }}
                                                  mb-3">
                                        <div class="timeline-icon icon-item icon-item-lg text-primary border-300">
                                            <svg class="svg-inline--fa fa-envelope fa-w-16 fs-1" aria-hidden="true"
                                            ...
                                            <div class="col-lg-6 timeline-item-time">
                                                <div>
                                                    <h6 class="mb-0 text-700">
                                                        {{ $formation->created_at->locale('fr-FR')->format('Y') }}
                                                    </h6>
                                                    <p class="fs--2 text-500 font-sans-serif">
                                                        {{ $formation->created_at->locale('fr-FR')->format('d') }}
                                                        {{ $formation->created_at->locale('fr-FR')->format('F') }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="timeline-item-content arrow-bg-white">
                                                    <div class="timeline-item-card bg-white dark__bg-1100"><a
                                                        ...
                                                        <p class="fs--1 mb-0 text-600">
                                                            Heure depart : {{ $formation->heure_depart }}
                                                        </p>

                                                        <p class="fs--1 mb-0 text-600">
                                                            Heure sortie : {{ $formation->heure_sortie }}
                                                        </p>
                                                        ...
                                                        <div class="d-flex flex-wrap pt-2">
                                                            <h6 class="mb-0 text-600 lh-base"><svg
                                                                ...
                                                                {{ $formation->created_at->toTimeString() }}</h6>
                                                            <div
                                                                ...
                                                                class="badge rounded badge-subtle-success false">{{ $formation->prof_m . ' m' }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
