...
<div class="card mb-3">
  ...
  <div class="card-body position-relative">
    <div class="row">
      <div class="col-lg-8">
        <h3>Fiche de suivi prépa de {{$plongeur->nom}} {{$plongeur->prenom}} pour Niveau 3
        </h3>
...
<form method="POST" action="{{ route('suiviPrepa.store') }}">
  @csrf
      ...
      <div class="row">
        <div class="col-2">
          ...
          <input class="form-control" id="saison" name="saison" type="text"
            value="{{$suiviPrepa->first() && $suiviPrepa->first()->saison ? $suiviPrepa->first()->saison: ""}}" />
        </div>
        <div class="col-3">
          ...
          <select class="form-select js-choice" id="encadrant" size="1" name="encadrant"
            ...
            <option value={{ $user->id }}
              {{$suiviPrepa->first() && $user->id == $suiviPrepa->first()->id_encadrant ? 'selected' : '' }}>
        ...
        <div class="col-3">
          ...
          <select class="form-select js-choice" id="niveau" size="1" name="niveau"
            ...
            <option value={{ $niveau->id }} {{$niveau->id == 3 ? 'selected' : '' }}>
              {{ $niveau->label }}</option>
            @endforeach
          </select>
        </div>
        <input type="text" id="plongeur" name="plongeur" value="{{$plongeur->id}}" hidden>
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="capelage_un" name="capelage_un" type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_deux" name="capelage_deux" type="text"
                placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_trois" name="capelage_trois" type="text"
                placeholder="3"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->trois: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_quatre" name="capelage_quatre" type="text"
                placeholder="4"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->quatre: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_cinq" name="capelage_cinq" type="text"
                placeholder="5"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->cinq: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_six" name="capelage_six" type="text" placeholder="6"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->six: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_sept" name="capelage_sept" type="text"
                placeholder="7"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->sept: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_huit" name="capelage_huit" type="text"
                placeholder="8"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->huit: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_neuf" name="capelage_neuf" type="text"
                placeholder="9"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->neuf: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="capelage_dix" name="capelage_dix" type="text" placeholder="10"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',11) ? $suiviPrepa->firstWhere('id',11)->dix: ""}}" />
            </div>
          </div>
        </div>
        <div class="row mb-2">
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="palmage_en_immersion_un" name="palmage_en_immersion_un"
                type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',13) ? $suiviPrepa->firstWhere('id',13)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="palmage_en_immersion_deux" name="palmage_en_immersion_deux"
                type="text" placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',13) ? $suiviPrepa->firstWhere('id',13)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="palmage_en_immersion_trois" name="palmage_en_immersion_trois"
                type="text" placeholder="3"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',13) ? $suiviPrepa->firstWhere('id',13)->trois: ""}}" />
            </div>
            <div>
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="utilisation_detendeur_un" name="utilisation_detendeur_un"
                type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',15) ? $suiviPrepa->firstWhere('id',15)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="utilisation_detendeur_deux" name="utilisation_detendeur_deux"
                type="text" placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',15) ? $suiviPrepa->firstWhere('id',15)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="utilisation_detendeur_trois"
                ...
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',15) ? $suiviPrepa->firstWhere('id',15)->trois: ""}}" />
            </div>
            <div>
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="ventilation_immersion_un" name="ventilation_immersion_un"
                type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',17) ? $suiviPrepa->firstWhere('id',17)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="ventilation_immersion_deux" name="ventilation_immersion_deux"
                type="text" placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',17) ? $suiviPrepa->firstWhere('id',17)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="ventilation_immersion_trois"
                ...
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',17) ? $suiviPrepa->firstWhere('id',17)->trois: ""}}" />
            </div>
            <div>
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="mi_un" name="mi_un" type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_deux" name="mi_deux" type="text" placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_trois" name="mi_trois" type="text" placeholder="3"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->trois: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_quatre" name="mi_quatre" type="text" placeholder="4"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->quatre: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_cinq" name="mi_cinq" type="text" placeholder="5"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->cinq: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_six" name="mi_six" type="text" placeholder="6"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->six: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_sept" name="mi_sept" type="text" placeholder="7"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->sept: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_huit" name="mi_huit" type="text" placeholder="8"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->huit: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_neuf" name="mi_neuf" type="text" placeholder="9"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->neuf: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="mi_dix" name="mi_dix" type="text" placeholder="10"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',29) ? $suiviPrepa->firstWhere('id',29)->dix: ""}}" />
            </div>
          </div>
        </div>
        <div class="row mb-2">
          ...
          <div class="col-9 d-flex justify-content-between gap-3">
            <div>
              <input class="form-control text-center" id="panne_air_un" name="panne_air_un" type="text" placeholder="1"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->un: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_deux" name="panne_air_deux" type="text"
                placeholder="2"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->deux: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_trois" name="panne_air_trois" type="text"
                placeholder="3"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->trois: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_quatre" name="panne_air_quatre" type="text"
                placeholder="4"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->quatre: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_cinq" name="panne_air_cinq" type="text"
                placeholder="5"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->cinq: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_six" name="panne_air_six" type="text"
                placeholder="6"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->six: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_sept" name="panne_air_sept" type="text"
                placeholder="7"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->sept: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_huit" name="panne_air_huit" type="text"
                placeholder="8"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->huit: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_neuf" name="panne_air_neuf" type="text"
                placeholder="9"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->neuf: ""}}" />
            </div>
            <div>
              <input class="form-control text-center" id="panne_air_dix" name="panne_air_dix" type="text"
                placeholder="10"
                value="{{$suiviPrepa &&$suiviPrepa->firstWhere('id',32) ? $suiviPrepa->firstWhere('id',32)->dix: ""}}" />
            </div>
          </div>
        </div>
        <div class="row mb-2">
