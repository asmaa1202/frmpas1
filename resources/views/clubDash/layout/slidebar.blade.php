        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('club.index') }}" role="button" data-bs-toggle=""
                        aria-expanded="false">
                    ...
                    <a class="nav-link" href="{{ route('compteClub.index') }}" role="button"
                    ...
                    <ul class="nav collapse show" id="moniteurs" style="">
                        <li class="nav-item"><a class="nav-link" href="{{ route('club.moniteurs.index') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Liste Moniteurs</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('club.moniteurs.inactifs') }}">
                    ...
                    <ul class="nav collapse show" id="email" style="">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('club.demandes_licence.en_attentes') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licences En <br>Attentes<span class="badge rounded-pill ms-2 bg-200 text-primary">{{ Licence::where('statut', 'en cours')->whereHas('plongeur', function ($query) {
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('club.demandes_licence.en_cours_validation') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licences En cours Validation<span class="badge rounded-pill ms-2 bg-200 text-primary">{{ Licence::where('statut', 'en_cours_validation')->whereHas('plongeur', function ($query) {
                                                                                                                                                                                                    $query->where('club_id', Auth::user()->club->id);
                                                                                                                                                                                                })->count()}}</span></span>
                                </div>
                            </a><!-- more inner pages-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('club.demandes_licence.acceptees') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licences Acceptées</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('club.demandes_licence.refusees') }}">
