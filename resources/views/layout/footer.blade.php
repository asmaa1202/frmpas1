        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 text-center text-lg-left animate" data-animation="fadeInUp">
                <div class="widget widget_text">
                    <img src="{{asset('assets/img/Logo_FRMPAS_mini.png')}}" alt="logo">
                    <p>
            ...
            <div class="col-xl-3 col-lg-5 text-center text-lg-left animate" data-animation="fadeInUp">
                <div class="widget widget_nav_menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            <a href="{{route('activites.subaquatiques')}}">Activités subaquatiques</a>
                        </li>
                        {{-- <li class="menu-item">
            ...
            <div class="col-xl-2 col-lg-5 text-center text-lg-left animate">
                <div class="widget widget_nav_menu">
                    ...
                    <ul class="menu">
                        <li class="menu-item">
                            <a href="{{route('sport.club')}}">Club</a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('sport.competition')}}">Competition</a>
                        </li>
                    </ul>
                </div>
                <div class="widget widget_nav_menu">
                    ...
                    <ul class="menu">
                        <li class="menu-item">
                            <a href="{{route('plongee.club')}}">Club</a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('plongee.formation')}}">Formation</a>
                        </li>
                    </ul>
                </div>
            </div>						
{{-- 
            <div class="col-xl5 col-lg-4 text-center text-lg-left animate" data-animation="fadeInUp">
