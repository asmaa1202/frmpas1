...
<head>
    ...
    <script src={{ asset('dashboard/vendors/overlayscrollbars/OverlayScrollbars.min.js') }}></script>
    ...
    <link
        ...
        rel="stylesheet">
    <link href={{ asset('dashboard/vendors/overlayscrollbars/OverlayScrollbars.min.css') }} rel="stylesheet">
    <link href={{ asset('dashboard/vendors/select2-bootstrap-5-theme/select2-bootstrap-5-theme.min.css') }}
        rel="stylesheet">
    <link href={{ asset('dashboard/vendors/simplebar/simplebar.min.css') }} rel="stylesheet" />
    <link href={{ asset('dashboard/css/theme-rtl.min.css') }} rel="stylesheet" id="style-rtl">
    <link href={{ asset('dashboard/css/theme.min.css') }} rel="stylesheet" id="style-default">
    <link href={{ asset('dashboard/css/user-rtl.min.css') }} rel="stylesheet" id="user-style-rtl">
    <link href={{ asset('dashboard/css/user.min.css') }} rel="stylesheet" id="user-style-default">
...
<body>
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            @include('plongeurDash.layout.slidebar')
            <div class="content">
                @include('plongeurDash.layout.header')
                @yield('content')
                @include('plongeurDash.layout.footer')
            </div>
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src={{ asset('dashboard/img/generic/falcon-mode-default.jpg') }}
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src={{ asset('dashboard/img/generic/falcon-mode-dark.jpg') }}
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src={{ asset('dashboard/img/icons/left-arrow-from-left.svg') }} width="20"
                        alt="" />
                    <div class="flex-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src={{ asset('dashboard/img/icons/arrows-h.svg') }} width="20" alt="" />
                    <div class="flex-1">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2"
                    src={{ asset('dashboard/img/icons/paragraph.svg') }} width="20" alt="" />
                <div class="flex-1">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                class="img-fluid img-prototype" src={{ asset('dashboard/img/generic/default.png') }}
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype" src={{ asset('dashboard/img/generic/inverted.png') }}
                                alt="" /><span class="label-text">
                                Inversé</span></label>
                    </div>
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype" src={{ asset('dashboard/img/generic/card.png') }}
                                alt="" /><span class="label-text">
                                Carte</span></label>
                    </div>
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype" src={{ asset('dashboard/img/generic/vibrant.png') }}
                                alt="" /><span class="label-text">
                                Vibrant</span></label>
                    </div>
                </div>
    ...
    <script src={{ asset('dashboard/vendors/swiper/swiper-bundle.min.js') }}></script>
