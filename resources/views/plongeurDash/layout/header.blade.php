<nav class=" navbar-light navbar-glass navbar-top navbar-expand" style="padding-top: 0px;padding-left: 0px;">
    ...
    <ul class="navbar-nav align-items-center d-none d-lg-block">
        <li class="nav-item">
            <div class="search-box" data-list='{"valueNames":["title"]}'>
                ...
                <a href={{ route('plongeur.dashboard') }}>
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Déconnexion">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                ...
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    <a class="dropdown-item" href="#"
                        ...
                        déconnecter</a>
                    <form id="logout-form" action="{{ route('plongeur.logout.submit') }}" method="POST" class="d-none">
                        @csrf
                    </form>
                </div>
            </div>
