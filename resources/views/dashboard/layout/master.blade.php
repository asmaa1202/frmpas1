...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href={{ asset('dashboard/img/cacher.png') }}>
    <link rel="icon" type="image/png" sizes="16x16" href={{ asset('dashboard/img/cacher.png') }}>
    <link rel="shortcut icon" type="image/x-icon" href={{ asset('dashboard/img/cacher.png') }}>
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src={{ asset('dashboard/img/generic/falcon-mode-dark.jpg') }} alt="" /></span><span
                                class="label-text">
                                Dark</span></label>
                    </div>
                </div>
