<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="padding-top: 0px;padding-left: 0px;">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="index.html">
        <div class="d-flex align-items-center"><img class="me-2"
                src={{ asset('/images/logo.png') }} alt="" width="40" />
        </div>
    </a>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l status-online me-2">
                                    <img class="rounded-circle" src={{ asset('dashboard/img/team/1.jpg') }} alt="" />
                                </div>
                                <div class="flex-1">
                        ...
                        <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src={{ asset('dashboard/img/team/2.jpg') }} alt="" />
                        ...
                        <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src={{ asset('dashboard/img/team/3.jpg') }} alt="" />
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        <li class="nav-item dropdown px-2">
            ...
            <a href={{ 'https://diver.cdma-solution.ma' }} class="btn btn-circle navbar-toggler-humburger-icon navbar-vertical-toggle"
                            ...
                            <div class="list-group-item">
                                <a class="notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle"
                                                src={{ asset('dashboard/img/icons/weather-sm.jpg') }} alt="" />
