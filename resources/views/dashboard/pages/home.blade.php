...
<div class="card mb-3">
    <div class="card-body d-flex">
        ...
        <div class="ps-3">
            ...
            <span class="lead d-block">{{$me->nom . ' ' . $me->prenom}}</span>
            <span>{{$me->email}}</span>
        </div>
    </div>
</div>
                        ...
                        <div class="card overflow-hidden" style="min-width: 12rem">
                            ...
                            <div class="card-body position-relative">
                                ...
                                <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-warning">
                                    ...
                                    href="{{route('clubs.index')}}">Voir tout<span
                        ...
                        <div class="card overflow-hidden" style="min-width: 12rem">
                            ...
                            <div class="card-body position-relative">
                                ...
                                <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-info">
                                    {{$clubsInactifs}}
                                </div><a class="fw-semi-bold fs--1 text-nowrap" href="{{route('clubs.inactifs')}}">Voir tout
                    ...
                    <div class="col-sm-6">
                        <div class="card overflow-hidden" style="min-width: 12rem">
                            ...
                            <div class="card-body position-relative">
                                ...
                                </div><a class="fw-semi-bold fs--1 text-nowrap" href="{{route('clubs.index')}}">Voir tout
                            ...
                            <div class="col-6">
                                <div class="d-flex flex-between-center mb-1">
                                    <div class="d-flex align-items-center"><span class="dot bg-primary"></span><span
                                            class="fw-semi-bold">Niveau 1 ({{$countNiveau1Plongeur}})</span></div>
                                    <div class="d-xxl-none">{{$countNiveau1Plongeur}}</div>
                                    <input id="countNiveau1Plongeur" hidden="true" value="{{$countNiveau1Plongeur}}">
                                </div>
                                <div class="d-flex flex-between-center mb-1">
                                    <div class="d-flex align-items-center"><span class="dot bg-info"></span><span
                                            class="fw-semi-bold">Niveau 2 ({{$countNiveau2Plongeur}})</span></div>
                                    <div class="d-xxl-none">{{$countNiveau2Plongeur}}</div>
                                    <input id="countNiveau2Plongeur" hidden="true" value="{{$countNiveau2Plongeur}}">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-flex flex-between-center mb-1">
                                    <div class="d-flex align-items-center"><span class="dot bg-400"></span><span
                                            class="fw-semi-bold">Niveau 3 ({{$countNiveau3Plongeur}})</span></div>
                                    <div class="d-xxl-none">{{$countNiveau3Plongeur}}</div>
                                    <input id="countNiveau3Plongeur" hidden="true" value="{{$countNiveau3Plongeur}}">
                                </div>
                                <div class="d-flex flex-between-center mb-1">
                                    <div class="d-flex align-items-center"><span class="dot bg-success"></span><span
                                            class="fw-semi-bold">Niveau 4 ({{$countNiveau4Plongeur}})</span></div>
                                    <div class="d-xxl-none">{{$countNiveau4Plongeur}}</div>
                                    <input id="countNiveau4Plongeur" hidden="true" value="{{$countNiveau4Plongeur}}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-auto align-self-end">
                        <div class="fs-4 fw-normal font-sans-serif text-700 lh-1 mb-1">
                            {{$countEnfantPlongeur +$countFemmePlongeur+$countHommePlongeur }}</div>
                ...
                <div class="row h-100 justify-content-between g-0">
                    <div class="col-5 col-sm-6 col-xxl pe-2">
                        ...
                        <div class="fs--2 mt-3">
                            <div class="d-flex flex-between-center mb-1">
                                <div class="d-flex align-items-center"><span class="dot bg-primary"></span><span
                                        class="fw-semi-bold">Homme ({{$countHommePlongeur}})</span></div>
                                <div class="d-xxl-none">{{$countHommePlongeur}}</div>
                                <input id="countHommePlongeur" hidden="true" value="{{$countHommePlongeur}}">
                            </div>
                            <div class="d-flex flex-between-center mb-1">
                                <div class="d-flex align-items-center"><span class="dot bg-info"></span><span
                                        class="fw-semi-bold">Femme ({{$countFemmePlongeur}})</span></div>
                                <div class="d-xxl-none">{{$countFemmePlongeur}}</div>
                                <input id="countFemmePlongeur" hidden="true" value="{{$countFemmePlongeur}}">
                            </div>
                            <div class="d-flex flex-between-center mb-1">
                                <div class="d-flex align-items-center"><span class="dot bg-300"></span><span
                                        class="fw-semi-bold">Enfant ({{$countEnfantPlongeur}})</span></div>
                                <div class="d-xxl-none">{{$countEnfantPlongeur}}</div>
                                <input id="countEnfantPlongeur" hidden="true" value="{{$countEnfantPlongeur}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                        <div class="d-flex align-items-center"><img class="me-3"
                                src={{ asset("dashboard/img/icons/weather-icon.png") }} alt="" height="60">
                            <div>
