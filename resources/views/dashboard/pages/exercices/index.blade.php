    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="{{ route('exercices.create') }}" role="button" class="btn btn-outline-primary">
            ...
            <table id="example" class="table table-bordered data-table table-striped fs--1 mb-0" data-options='{"paging":true,"scrollY":"600px","searching":true,"scrollCollapse":true,"scrollX":true, "language": {
                ...
                <tbody class="list">
                    ...
                    <tr id="row{{ $item->id }}">
                        ...
                        <td class="align-middle">{{ $item->obligatoire ? "Oui" : "Non"}}</td>
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item"
                                            href="{{ route('exercices.show', ['id' => $item->id]) }}">Modifier</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" id="liveToastBtn"
                                                onclick="deleteExercice({{ $item->id }})">Oui</button>
