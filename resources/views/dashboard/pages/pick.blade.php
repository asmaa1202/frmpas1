        ...
        <div class="row g-0 g-md-3 justify-content-end">
          <div class="col-auto">
            <div class="d-flex align-items-center">
              <a class="btn btn-sm btn-primary" href="{{ route('cart') }}">Confirmer</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body p-0 d-flex flex-column justify-content-between">
        <div style="display: flex;flex-direction: column;height: 100%;">
          <div class="hoverbox text-center" style="flex:1"><a class="text-decoration-none"
              href={{ asset("dashboard/video/beach.mp4")}} data-gallery="attachment-bg"><img class="fit-cover"
            ...
            <div class="hoverbox-content flex-center pe-none bg-holder overlay overlay-2"><img class="z-index-1"
                src={{ asset('dashboard/img/icons/play.svg') }} width="60" alt="" /></div>
          </div>
          <div class="p-3">
