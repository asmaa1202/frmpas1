...
@section('title')
<title>FRMPAS - Modifier cours</title>
@endsection
...
<div class="row g-0">
    <div class="col-lg-12 pe-lg-2">
        ...
        <div class="card mb-3">
            <div class="card-body ">
                <img src="{{ $cours->image }}" id="image" width="130">
                <div class="mb-3 ">
                    <label for="formFile" class="form-label">Document :</label>
                    <input class="form-control" type="file" value="{{ old('image', $cours->image) }}" name="file"
            ...
            <div class="card-body">
                <div class="row gx-2">
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="nom" value="{{ old('nom', $cours->nom) }}" type="text" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="niveau">Niveau :</label>
                        <input class="form-control js-choice" id="id_level"
                            value="{{ old('id_level', $cours->id_level) }}" type="text" name="niveau"
                            required="required" size="1" data-options='{"removeItemButton":true,"placeholder":false}' />
                    </div>
                </div>
            </div>
        </div>
...
<div class="card mt-3">
    <div class="card-body">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <button class="btn btn-primary me-3" onclick="modifierCours({{ $cours->id }})" id="liveToastBtn">
    ...
    let file;
        ...
        async function modifierCours(id) {
            try {
                ...
                const res = await axios.post(`/dashboard/cours/modifier/${id}`, formData, {
                    headers: {
