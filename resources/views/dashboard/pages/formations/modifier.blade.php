    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <button class="btn btn-primary me-3" onclick="updateFormations({{ $formation->id }})" id="liveToastBtn">
            ...
            <div class="card-body">
                <div class="row gx-2">
                    <div class="col-6 mb-3">
                        ...
                        <input class="form-control" id="nom" type="text" value="{{ old('nom', $formation->nom) }}" />
                    </div>
                    <div class="col-6 mb-3">
                        ...
                        <select class="form-select js-choice" id="plongeur" size="1" name="plongeur"
                            ...
                            <option selected={{ old('id_plongeur', $formation->id_plongeur) }}
                                value="{{ $plongeur->id }}">{{ $plongeur->nom . ' ' . $plongeur->prenom }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-6 mb-3">
                        ...
                        <select class="form-select js-choice" id="formateur" size="1" name="formateur"
                            ...
                            <option selected={{ old('id_formateur', $formation->id_formateur) }}
                                value="{{ $formateur->id }}">{{ $formateur->nom . ' ' . $formateur->prenom }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <input class="form-control datetimepicker" id="heure_depart" type="text" placeholder="H:i"
                            value="{{ old('heure_depart', $formation->heure_depart) }}"
...
<script>
    async function updateFormations(id) {
            try {
                ...
                const res = await axios.put(`/dashboard/formations/${id}`, {
                    nom,
                    plongeur,
                    formateur,
                    heure_depart,
