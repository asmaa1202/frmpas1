                ...
                <table class="table table-bordered data-table table-striped fs--1 mb-0"
                    ...
                    <tbody class="list">
                        ...
                        <tr id="row{{ $item->id }}">
                            ...
                            <td class="align-middle">{{ $item->plongeur->nom . ' ' . $item->plongeur->prenom }}</td>
                            <td class="align-middle">{{ $item->formateur->nom . ' ' . $item->formateur->prenom }}
                            </td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-0"
                                        ...
                                        <div class="py-2">
                                            <a class="dropdown-item"
                                                href="{{ route('formations.show', ['id' => $item->id]) }}">Modifier</a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" id="liveToastBtn"
                                                    onclick="deleteFormation({{ $item->id }})">Oui</button>
