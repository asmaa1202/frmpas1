    ...
    <div class="modal fade" id="addEventModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content border">
                <form id="addEventForm" method="POST" autocomplete="off" action="<?php echo e(route('calendrier.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/calendrier/index.blade.php ENDPATH**/ ?>