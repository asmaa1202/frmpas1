                        ...
                        <td class="align-middle white-space-nowrap py-2">
                            <div class="d-flex d-flex align-items-center">
                                <div class="avatar avatar-xl me-2">
                                    <img class="rounded-circle" src=<?php echo e("https://asaam.ma/images/logo.png"); ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item"
                                            href="<?php echo e(route('clubs.show', ['id' => $item->id])); ?>">Modifier</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/club/index.blade.php ENDPATH**/ ?>