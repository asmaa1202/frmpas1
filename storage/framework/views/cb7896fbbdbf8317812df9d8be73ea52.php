...
<head>
    ...
    <script src=<?php echo e(asset('dashboard/js/config.js')); ?>></script>
    <script src=<?php echo e(asset('dashboard/vendors/overlayscrollbars/OverlayScrollbars.min.js')); ?>></script>
    ...
    <link href=<?php echo e(asset('dashboard/vendors/flatpickr/flatpickr.min.css')); ?> rel="stylesheet">

    <link href=<?php echo e(asset('dashboard/vendors/choices/choices.min.css')); ?> rel="stylesheet" />
    <link href=<?php echo e(asset('dashboard/vendors/dropzone/dropzone.min.css')); ?> rel="stylesheet" />
    <link href=<?php echo e(asset('dashboard/vendors/prism/prism-okaidia.css')); ?> rel="stylesheet">
    <link href=<?php echo e(asset('dashboard/vendors/swiper/swiper-bundle.min.css')); ?> rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,500,600,700%7cPoppins:300,400,500,600,700,800,900&amp;display=swap"
        rel="stylesheet">
    <link href=<?php echo e(asset('dashboard/vendors/overlayscrollbars/OverlayScrollbars.min.css')); ?> rel="stylesheet">
    <link href=<?php echo e(asset('dashboard/vendors/select2-bootstrap-5-theme/select2-bootstrap-5-theme.min.css')); ?>

        rel="stylesheet">
    <link href=<?php echo e(asset('dashboard/vendors/simplebar/simplebar.min.css')); ?> rel="stylesheet" />
    <link href=<?php echo e(asset('dashboard/css/theme-rtl.min.css')); ?> rel="stylesheet" id="style-rtl">
    <link href=<?php echo e(asset('dashboard/css/theme.min.css')); ?> rel="stylesheet" id="style-default">
    <link href=<?php echo e(asset('dashboard/css/user-rtl.min.css')); ?> rel="stylesheet" id="user-style-rtl">
    <link href=<?php echo e(asset('dashboard/css/user.min.css')); ?> rel="stylesheet" id="user-style-default">
...
<body>
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <?php echo $__env->make('plongeurDash.layout.slidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="content">
                <?php echo $__env->make('plongeurDash.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->yieldContent('content'); ?>
                <?php echo $__env->make('plongeurDash.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-header settings-panel-header bg-shape">
            <div class="z-index-1 py-1 light">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h5 class="text-white mb-0 me-2"><span class="fas fa-palette me-2 fs-0"></span>Paramètres</h5>
                    <button class="btn btn-primary btn-sm rounded-pill mt-0 mb-0" data-theme-control="reset"
                        style="font-size:12px"> <span class="fas fa-redo-alt me-1"
                            data-fa-transform="shrink-3"></span>Réinitialiser</button>
                </div>
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
            <h5 class="fs-0">Schéma de couleur</h5>
            <p class="fs--1">Choisissez le mode de couleur parfait pour votre application.</p>
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src=<?php echo e(asset('dashboard/img/generic/falcon-mode-default.jpg')); ?>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src=<?php echo e(asset('dashboard/img/generic/falcon-mode-dark.jpg')); ?>
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src=<?php echo e(asset('dashboard/img/icons/left-arrow-from-left.svg')); ?> width="20"
                        alt="" />
                    <div class="flex-1">
                        <h5 class="fs-0">Mode RTL</h5>
                        <p class="fs--1 mb-0">Changez de sens de langue </p>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src=<?php echo e(asset('dashboard/img/icons/arrows-h.svg')); ?> width="20" alt="" />
                    <div class="flex-1">
                        <h5 class="fs-0">Disposition fluide</h5>
                        <p class="fs--1 mb-0">Basculer le système de mise en page du conteneur</p>
                    </div>
                </div>
                <div class="form-check form-switch">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2"
                    src=<?php echo e(asset('dashboard/img/icons/paragraph.svg')); ?> width="20" alt="" />
                <div class="flex-1">
                    <h5 class="fs-0 d-flex align-items-center">Emplacement de navigation </h5>
                    <p class="fs--1 mb-2">Sélectionnez un système de navigation adapté à votre application Web </p>
                    <div>
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="option-navbar-vertical">Verticale</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="option-navbar-top" type="radio" name="navbar"
                                ...
                                data-theme-control="navbarPosition" />
                            <label class="form-check-label" for="option-navbar-top">Haut</label>
                        </div>
                        <div class="form-check form-check-inline me-0">
                            <input class="form-check-input" id="option-navbar-combo" type="radio" name="navbar"
                                ...
                                data-theme-control="navbarPosition" />
                            <label class="form-check-label" for="option-navbar-combo">Combiné</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <p class="fs--1 mb-0">Basculez entre les styles de votre barre de navigation verticale </p>
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                class="img-fluid img-prototype" src=<?php echo e(asset('dashboard/img/generic/default.png')); ?>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype" src=<?php echo e(asset('dashboard/img/generic/inverted.png')); ?>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype" src=<?php echo e(asset('dashboard/img/generic/card.png')); ?>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype" src=<?php echo e(asset('dashboard/img/generic/vibrant.png')); ?>
        ...
        <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
            <div class="bg-soft-primary position-relative rounded-start" style="height:34px;width:28px">
                ...
                class="text-uppercase text-primary fw-bold bg-soft-primary py-2 pe-2 ps-1 rounded-end">Réglages</small>
        </div>
    </a>
    ...
    <script src=<?php echo e(asset('dashboard/vendors/jquery/jquery.min.js')); ?>></script>
    ...
    <script src=<?php echo e(asset('dashboard/vendors/dropzone/dropzone.min.js')); ?>></script>
    ...
    <script src=<?php echo e(asset('dashboard/vendors/echarts/echarts.min.js')); ?>></script>
    <script src=<?php echo e(asset('dashboard/vendors/prism/prism.js')); ?>></script>
    <script src=<?php echo e(asset('dashboard/vendors/lodash/lodash.min.js')); ?>></script>
    <script src=<?php echo e(asset('dashboard/vendors/swiper/swiper-bundle.min.js')); ?>></script>
...
<?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/plongeurDash/layout/master.blade.php ENDPATH**/ ?>