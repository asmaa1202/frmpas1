                ...
                <div class="vertical-item content-padding hero-bg">
                    <div class="item-media">
                        <div class="owl-carousel" data-margin="0" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-responsive-xs="1" data-dots="true">
                            <a href="<?php echo e(asset('assets/images/gallery/04.jpg')); ?>" class="photoswipe-link" data-width="850" data-height="400">
                                <img src="<?php echo e(asset('assets/images/gallery/04.jpg')); ?>" alt="img">
                            </a>
                            <a href="<?php echo e(asset('assets/images/gallery/05.jpg')); ?>" class="photoswipe-link" data-width="850" data-height="400" data-iframe="https://www.youtube.com/embed/mcixldqDIEQ">
                                <img src="<?php echo e(asset('assets/images/gallery/05.jpg')); ?>" alt="img">
                            </a>
                            <a href="<?php echo e(asset('assets/images/gallery/06.jpg')); ?>" class="photoswipe-link" data-width="850" data-height="400" data-iframe="//player.vimeo.com/video/1084537">
                                <img src="<?php echo e(asset('assets/images/gallery/06.jpg')); ?>" alt="img">
                            </a>
                            <a href="<?php echo e(asset('assets/s/gallery/07.jpg')); ?>" class="photoswipe-link" data-width="850" data-height="400">
                                <img src="<?php echo e(asset('assets/s/gallery/07.jpg')); ?>" alt="img">
                            </a>
                        </div>
                    </div>
        ...
        <div class="row">
            <!-- Loop through your images here -->
                ...
                <div class="col-md-4 mb-3">
                    <a href="<?php echo e(asset('assets/images/gallery/04.jpg')); ?>" data-pswp-width="850" data-pswp-height="400" target="_blank" class="gallery-item">
                        <img src="<?php echo e(asset('assets/images/gallery/04.jpg')); ?>" alt="Image description" class="img-fluid">
                    </a>
                </div>
                <div class="col-md-4 mb-3">
                    <a href="<?php echo e(asset('assets/images/gallery/04.jpg')); ?>" data-pswp-width="850" data-pswp-height="400" target="_blank" class="gallery-item">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/accueil/galerie/detail_galerie.blade.php ENDPATH**/ ?>