                ...
                <div class="card-header position-relative min-vh-25 mb-8">
                    ...
                    <div class="avatar avatar-5xl avatar-profile shadow-sm img-thumbnail rounded-circle">
                        <div class="h-100 w-100 rounded-circle overflow-hidden position-relative">
                            <img src=<?php echo e($utilisateur->image ? $utilisateur->image : asset('/dashboard/img/team/avatar.png')); ?> width="200" alt=""
...
unset($__errorArgs, $__bag); ?>" id="prenom"
                                    name="prenom" value="<?php echo e(old('prenom', $utilisateur->prenom)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email"
                                    name="email" value="<?php echo e(old('email', $utilisateur->email)); ?>">
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/utilisateur/modifier.blade.php ENDPATH**/ ?>