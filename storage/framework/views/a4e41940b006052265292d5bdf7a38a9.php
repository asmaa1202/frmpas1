    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="<?php echo e(route('cours.index')); ?>" role="button" class="btn btn-outline-primary">
                ...
                <div class="row gx-2">
                    ...
                    <div>
                        ...
                        <select class="form-select js-choice" id="niveau" size="1" name="niveau"
                            ...
                            <option value="<?php echo e($level->id); ?>"><?php echo e($level->label); ?></option>
...
<script>
    initLargeUpload('<?php echo e(route('chunkUpload')); ?>', $('.uploadProgressBar'));
    var file = "";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/cours/ajouter.blade.php ENDPATH**/ ?>