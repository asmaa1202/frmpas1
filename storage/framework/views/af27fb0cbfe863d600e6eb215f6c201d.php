            ...
            <main class="col-lg-7 col-xl-8">
                ...
                <article class="vertical-item content-padding hero-bg post type-post status-publish format-standard has-post-thumbnail">
                   ...
                   <div class="text-center">
                            <img src="<?php echo e(asset('assets/images/team/pesident.jpeg')); ?>" alt="img" style="width: 180px !important;height: 220px !important;">
                        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/accueil/frmpas_family/mot_president.blade.php ENDPATH**/ ?>