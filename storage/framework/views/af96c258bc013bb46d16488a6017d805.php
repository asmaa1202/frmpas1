    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="<?php echo e(route('exercices.create')); ?>" role="button" class="btn btn-outline-primary">
            ...
            <table id="example" class="table table-bordered data-table table-striped fs--1 mb-0" data-options='{"paging":true,"scrollY":"600px","searching":true,"scrollCollapse":true,"scrollX":true, "language": {
                ...
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th style="min-width: 300px;">labele</th>
                        <th style="min-width: 120px;">Niveau</th>
                        <th style="min-width: 100px;">Obligatoire</th>
                        <th style="min-width: 220px;">Crée le</th>
                        <th style=" width: 80px;">Actions</th>
                    </tr>
                </thead>
                <tbody class="list">
                    <?php $__currentLoopData = $exercices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="row<?php echo e($item->id); ?>">
                        <td class="align-middle text-center"><?php echo e($item->id); ?></td>
                        <td class="align-middle"><?php echo e($item->label); ?></td>
                        <td class="align-middle"><?php echo e($item->niveau->label); ?></td>
                        <td class="align-middle"><?php echo e($item->obligatoire ? "Oui" : "Non"); ?></td>
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item"
                                            href="<?php echo e(route('exercices.show', ['id' => $item->id])); ?>">Modifier</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" id="liveToastBtn"
                                                onclick="deleteExercice(<?php echo e($item->id); ?>)">Oui</button>
...
<script>
    async function deleteExercice(id) {
            try {
                ...
                btnClose.click();
                const response = await axios.delete(`/dashboard/exercices/${id}`);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/exercices/index.blade.php ENDPATH**/ ?>