                        ...
                        <div class="accordion-body p-0">
                            <div class="card-body bg-light tab-pane active show" id="timeline" role="tabpanel"
                                ...
                                <div class="timeline-vertical py-0">
                                    ...
                                    <div class="timeline-item <?php echo e($loop->index % 2 == 0 ? 'timeline-item-start' : 'timeline-item-end'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plongeurDash.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/plongeurDash/pages/formations/index.blade.php ENDPATH**/ ?>