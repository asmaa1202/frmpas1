        ...
        <div class="container-fluid">
            <div class="row min-vh-100 bg-100">
                <div class="col-6 d-none d-lg-block position-relative">
                    <div class="bg-holder"
                        style="background-image:url(../../../images/scuba-diver-interacts-with-southern-stingrays-dasyatis-americana--e1634535801294-peqe4pdns5bvnvk2a1k2zejrgduixq7uj36kz2opeg.jpg);background-position: 50% 20%;">
                    </div>
                    <!--/.bg-holder-->
                        ...
                        <div class="col-lg-9 col-xl-8 col-xxl-6">
                            <div class="card">
                                <div class="card-header text-center p-2">
                                    <img src=<?php echo e(asset('images/logo.png')); ?> alt="" style="width: 250px">
                                </div>
...
<?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/auth/plongeur-login.blade.php ENDPATH**/ ?>