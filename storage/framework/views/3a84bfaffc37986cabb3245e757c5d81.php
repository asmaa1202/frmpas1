    ...
    <div class="card-body position-relative">
        <div id="tableExample">
            <div class="table-responsive">
                <table class="table table-bordered data-table table-striped fs--1 mb-0"
                    ...
                    <thead class="bg-200 text-900">
                        <tr>
                            ...
                            <th style="min-width: 220px;">Plongeur</th>
                            <th style="min-width: 220px;">Formateur</th>
                            <th style="min-width: 220px;">Heure depart</th>
                            <th style="min-width: 220px;">Heure sortie</th>
                            <th style="min-width: 220px;">Profondeur (m)</th>
                            <th style="min-width: 220px;">Observation</th>
                            <th style="min-width: 220px;">Crée par</th>
                            <th style="min-width: 220px;">Crée le</th>
                            <th style=" width: 80px;">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="list">
                        <?php $__currentLoopData = $formations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="row<?php echo e($item->id); ?>">
                            <td class="align-middle text-center"><?php echo e($item->id); ?></td>
                            <td class="align-middle"><?php echo e($item->nom); ?></td>
                            <td class="align-middle"><?php echo e($item->plongeur->nom . ' ' . $item->plongeur->prenom); ?></td>
                            <td class="align-middle"><?php echo e($item->formateur->nom . ' ' . $item->formateur->prenom); ?>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-0"
                                        ...
                                        <div class="py-2">
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('formations.show', ['id' => $item->id])); ?>">Modifier</a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" id="liveToastBtn"
                                                    onclick="deleteFormation(<?php echo e($item->id); ?>)">Oui</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/formations/index.blade.php ENDPATH**/ ?>