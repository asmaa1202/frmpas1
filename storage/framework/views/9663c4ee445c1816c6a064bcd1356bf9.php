        ...
        <li class="nav-item dropdown">
            <a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                ...
                <div class="avatar avatar-xl d-flex">
                    <img class="rounded-circle" src=<?php echo e(asset( Auth::guard('plongeurs')->user()->image )); ?> alt="" />
                </div>
            </a>
...
<?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/plongeurDash/layout/header.blade.php ENDPATH**/ ?>