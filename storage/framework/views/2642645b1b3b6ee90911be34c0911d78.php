                            ...
                            <div class="row mx-2">
                                <div class="form-check mb-0 lh-1 col-2">
                                    <input class="form-check-input genre" type="radio" value="Homme" name="genre"
                                        <?php echo e($plongeur->genre == 'Homme' ? 'checked' : ''); ?> id="home"
                                        name="view-settings" />
                                    <label class="form-check-label mb-0" for="home">Homme
                                    </label>
                                </div>
                                <div class="form-check mb-0 lh-1 col-2">
                                    <input class="form-check-input genre" type="radio" value="Femme" name="genre"
                                        id="femme" <?php echo e($plongeur->genre == 'Femme' ? 'checked' : ''); ?>
                    ...
                    <div class="row g-2">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control datetimepicker" id="date_naissance" type="text"
                                placeholder="d/m/yy" value="<?php echo e($plongeur->date_de_naissance); ?>" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="profession">Profession</label>
                            <input class="form-control" id="profession" type="text"
                                value="<?php echo e($plongeur->profession); ?>" />
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="phone_portable" data-input-mask='{"mask":"+212 999-999-999"}'
                                placeholder="+212 XXX-XXX-XXX" type="tel"
                                value="<?php echo e($plongeur->telephone_portable); ?>" />
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="phone_fixe_personne"
                                data-input-mask='{"mask":"+212 999-999-999"}' placeholder="+212 XXX-XXX-XXX"
                                type="tel" value="<?php echo e($plongeur->telephone_fixe_persone_cas_urgence); ?>" />
                        </div>
                        <div class="col-sm-6">
                            <label for="phone_portable_personne">Téléphone portable</label>
                            <input class="form-control" id="phone_portable_personne"
                                data-input-mask='{"mask":"+212 999-999-999"}' placeholder="+212 XXX-XXX-XXX"
                                type="tel" value="<?php echo e($plongeur->telephone_portable_persone_cas_urgence); ?>" />
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <div class="mb-2">
                            ...
                            <input class="form-control" id="adresse" type="text"
                                value="<?php echo e($plongeur->adresse); ?>" />
                        </div>
                        <div class="mb-2">
                            <label class="form-label" for="code_postal">Code postal</label>
                            <input class="form-control" id="code_postal" type="text"
                                value="<?php echo e($plongeur->code_postal); ?>" />
                        </div>
                        <div class="mb-2">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <div class="mb-2">
                            ...
                            <input class="form-control" id="n_licence" type="text"
                                value="<?php echo e($plongeur->n_licence); ?>" />
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select js-choice" id="niveaux" size="1" name="niveaux"
                                ...
                                <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value=<?php echo e($item->id); ?> <?php echo e($plongeur->id_niveau == $item->id ? 'selected' : ''); ?>><?php echo e($item->label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-2">
                            <label for="jour_entrainement">Jour d'entraînement</label>
                            <select class="form-select js-choice" id="jour_entrainement" size="1"
                                name="jour_entrainement" multiple="multiple"
        ...
        <div class="card-body">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <button class="btn btn-primary me-3" onclick="modifierPlongeur(<?php echo e($plongeur->id); ?>)"
                        id="liveToastBtn">
                        <i class="far fa-save me-1"></i>
                        Enregistrer
                    </button>
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/plongeur/modifier.blade.php ENDPATH**/ ?>