    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="<?php echo e(route('cours.create')); ?>" role="button" class="btn btn-outline-primary">
                    ...
                    <tbody class="list">
                        ...
                        <tr id="row<?php echo e($item->id); ?>">
                            ...
                            <td class="text-center align-middle">
                                <?php if($item->lien): ?>
                                <a href="<?php echo e($item->lien); ?>" target=”_blank”>Cours</a>
                                <?php endif; ?>
                            </td>
                            <td class="align-middle"><?php echo e($item->nom); ?></td>
                            <td class="align-middle">
                                <?php echo e($item->niveau != null && $item->niveau->label != null ? $item->niveau->label : null); ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" id="liveToastBtn"
                                                    onclick="deleteCours(<?php echo e($item->id); ?>)">Oui</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/cours/index.blade.php ENDPATH**/ ?>