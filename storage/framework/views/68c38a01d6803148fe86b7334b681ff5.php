                              ...
                              <tr>
                                <td class="es-infoblock" align="center"
                                  ...
                                  <p
                                    ...
                                    <a target="_blank" href="https://asaam.ma"
                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">https://www.asaam.ma</a>
                                  </p>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"
                                  align="center"><img
                                    src="https://xpszex.stripocdn.email/content/guids/CABINET_d8bb900afb983cff150cff8692c22905a7bafeb3dfc7e9348291379bfe8ac996/images/illustration_24.png"
                                    alt
                    ...
                    <td align="left" style="padding:20px;Margin:0">
                      <table width="100%" cellspacing="0" cellpadding="0"
                        ...
                        <tr class="es-visible-simple-html-only">
                          <td class="es-container-visible-simple-html-only" valign="top" align="center"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-c" align="center" style="padding:0;Margin:0">
                                  <h2
                                    ...
                                    Calendrier <span
                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:26px">#1</span><br
                                      type="_moz"></h2>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" style="padding:0;margin:0">
                                  <button class="msohide es-button-border"
                                    style="border-style:solid;border-color:#3d85c6;background:#3d85c6;border-width:2px;display:inline-block;border-radius:6px;width:auto;mso-hide:all"><a
                                      href="" class="es-button" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#3d85c6;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #3d85c6;padding-left:30px;padding-right:30px">Accepter</a>
                                  </button>
                                  <button class="msohide es-button-border ms-2"
                                    style="border-style:solid;border-color:#3d85c6;background:#3d85c6;border-width:2px;display:inline-block;border-radius:6px;width:auto;mso-hide:all"><a
                                      href="" class="es-button" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#3d85c6;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #c63d3d;padding-left:30px;padding-right:30px">Refuser</a>
                                  </button>
                                  <!--<![endif]-->
                                </td>
                              </tr>
                                  ...
                                  <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                      <td valign="top" align="center" style="padding:0;Margin:0;padding-right:40px"><img
                                          title="Facebook"
                                          src="https://xpszex.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                          alt="Fb" width="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                      </td>
                                      <td valign="top" align="center" style="padding:0;Margin:0;padding-right:40px"><img
                                          title="Twitter"
                                          src="https://xpszex.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
                                          alt="Tw" width="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                      </td>
                                      <td valign="top" align="center" style="padding:0;Margin:0;padding-right:40px"><img
                                          title="Instagram"
                                          src="https://xpszex.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                          alt="Inst" width="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                      </td>
                                      <td valign="top" align="center" style="padding:0;Margin:0"><img title="Youtube"
                                          src="https://xpszex.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                          alt="Yt" width="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                      </td>
                                    </tr>
...
</html><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/emails/calendrier.blade.php ENDPATH**/ ?>