        ...
        <div class="card-body position-relative">
            <div class="row">
                ...
                <div class="col-lg-4 d-flex justify-content-end align-items-center">
                    <button class="btn btn-primary me-3" onclick="updateExercices(<?php echo e($exercice->id); ?>)" id="liveToastBtn">
                ...
                <div class="card-body">
                    <div class="row gx-2">
                        ...
                        <div class="ps-2 mt-0 mb-3 d-flex">
                            <div class="form-check mb-0 mr-3 lh-1 me-3">
                                <input class="form-check-input obligatoire" type="radio" value="Oui" name="obligatoire"
                                       <?php echo e($exercice->obligatoire == 1 ? 'checked' : ''); ?>
                            ...
                            <div class="form-check mb-0 lh-1">
                                <input class="form-check-input obligatoire" type="radio" value="Non" name="obligatoire"
                                       <?php echo e($exercice->obligatoire == 0 ? 'checked' : ''); ?>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input class="form-control" id="label" type="text" value="<?php echo e($exercice->label); ?>"/>
                        </div>
                        <div class="col-6 mb-3">
                            ...
                            <select class="form-select js-choice" id="niveau" size="1" name="niveau"
                                ...
                                <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value=<?php echo e($niveau->id); ?> <?php echo e($exercice->id_niveau == $niveau->id ? 'selected' : ''); ?>><?php echo e($niveau->label); ?>
        ...
        <div class="card-body">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <button class="btn btn-primary me-3" onclick="updateFormations(<?php echo e($exercice->id); ?>)"
                        id="liveToastBtn">
                        <i class="far fa-save me-1"></i>
                        Enregistrer
                    </button>
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/exercices/modifier.blade.php ENDPATH**/ ?>