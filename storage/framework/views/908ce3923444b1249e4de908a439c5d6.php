    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="<?php echo e(route('club.athletes.create')); ?>" role="button" class="btn btn-outline-primary">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item"
                                            href="/club/athletes/modifier/<?php echo e($item->id); ?>">Modifier
                                        </a>
                                        <a class="dropdown-item"
                                            href="/club/athletes/<?php echo e($item->id); ?>/formations/niveau/<?php echo e($item->id_niveau); ?>">Formations
                                        </a>
                                        <a class="dropdown-item"
                                            href="/club/athletes/<?php echo e($item->id); ?>/carnet-de-plongee">Carnet de
                                            plongée
                                        </a>
                                        <a class="dropdown-item"
                                            href="/club/athletes/<?php echo e($item->id); ?>/niveau/1/suivi-prepa">Fiche de
                                            suivi
                                            prépa
                                        </a>
                                        <a class="dropdown-item"
                                            href="/club/athletes/<?php echo e($item->id); ?>/details">Details
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('clubDash.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\frmpas\resources\views/clubDash/pages/athletes/index.blade.php ENDPATH**/ ?>