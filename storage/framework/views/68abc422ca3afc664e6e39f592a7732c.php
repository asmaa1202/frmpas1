        ...
        <form>
            ...
            <div class="col-4 ps-3 text-center pt-2 d-none d-sm-block">
              <div class="rounded-1 p-2 mt-3 bg-100">
                <div class="text-uppercase fs-11 fw-bold">On accepte</div><img
                  src=<?php echo e(asset("dashboard/img/icons/icon-payment-methods-grid.png")); ?> alt="" width="120">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-7 col-xl-12 col-xxl-7 px-md-3 mb-xxl-0 position-relative">
              <div class="d-flex"><img class="me-3" src=<?php echo e(asset("dashboard/img/icons/shield.png")); ?> alt="" width="60"
                  height="60">
                <div class="flex-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/payement.blade.php ENDPATH**/ ?>