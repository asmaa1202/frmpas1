            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="club" style="">
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('clubs.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Liste Clubs</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('clubs.inactifs')); ?>">
                    ...
                    <ul class="nav collapse show" id="plongeur" style="">
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('plongeurs.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Liste Plongeurs</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('plongeurs.inactifs')); ?>">
                    ...
                    <ul class="nav collapse show" id="athlète" style="">
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('athletes.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Liste Athlètes</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('athletes.inactifs')); ?>">
                    ...
                    <ul class="nav collapse show" id="email" style="">
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('demandes.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Activation
                                        d'adhésion</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('demandes_licence.en_cous_validation')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licence En Attentes</span></div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('demandes_licence.acceptees')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licence Acceptées</span></div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('demandes_licence.refusees')); ?>">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licence Refusées</span></div>
                            </a><!-- more inner pages-->
                        </li>

                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('pick')); ?>">
                    ...
                    <ul class="nav collapse show" id="e-learning" style="">
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('formations.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Formation</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('exercices.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Licence
                                        Exercice</span></div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('cours.index')); ?>">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-2">Cours</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('calendriers.index')); ?>">
...
</nav><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/dashboard/layout/slidebar.blade.php ENDPATH**/ ?>