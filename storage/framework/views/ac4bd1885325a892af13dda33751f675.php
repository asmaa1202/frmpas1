            ...
            <div class="card-body d-flex flex-column justify-content-end">
                ...
                <div class="row justify-content-between">
                    <div class="col-auto align-self-end">
                        <div class="fs-4 fw-normal font-sans-serif text-700 lh-1 mb-1"><?php echo e($countEnfantPlongeur +$countFemmePlongeur+$countHommePlongeur); ?></div>
            ...
            <div class="card-body">
                <div class="row h-100 justify-content-between g-0">
                    ...
                    <div class="col-auto position-relative">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-dark fs-2"><?php echo e($countEnfantPlongeur +$countFemmePlongeur+$countHommePlongeur); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card h-md-100">
            ...
            <div class="card-body pt-2">
                <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                        <div class="d-flex align-items-center"><img class="me-3" src=<?php echo e(asset("dashboard/img/icons/weather-icon.png")); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/home.blade.php ENDPATH**/ ?>