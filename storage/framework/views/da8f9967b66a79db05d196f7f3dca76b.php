                    ...
                    <table id="example" class="table table-bordered data-table table-striped fs--1 mb-0" data-options='{"paging":true,"scrollY":"600px","searching":true,"scrollCollapse":true,"scrollX":true, "language": {
                        ...
                        <thead class="bg-200 text-900">
                            <tr>
                                ...
                                <th style="min-width: 200px;">Prénom</th>
                                <th style="min-width: 280px;">ville</th>
                                <th style="min-width: 180px;">Téléphone</th>
                                <th style="min-width: 180px;">CIN</th>
                                <th style="min-width: 180px;">Carte séjour</th>
                        ...
                        <tbody class="list">
                            <?php $__currentLoopData = $adhesions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row<?php echo e($item->id); ?>">
                                    ...
                                    <td class="align-middle"><?php echo e($item->prenom); ?></td>
                                    <td class="align-middle"><?php echo e($item->ville); ?></td>
                                    <td class="align-middle"><?php echo e($item->telephone); ?></td>
                                    <td class="align-middle"><?php echo e($item->CIN); ?></td>
                                    <td class="align-middle"><?php echo e($item->carte_sejour); ?></td>
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/adhesions/index.blade.php ENDPATH**/ ?>