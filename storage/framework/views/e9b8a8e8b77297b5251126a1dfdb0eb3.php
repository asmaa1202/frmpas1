                            ...
                            <?php $__currentLoopData = $type_sportifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check mb-0 lh-1 col-2">
                                    <input 
                                        ...
                                        name="types[]" 
                                        id="type_sportifs" 
                                        <?php echo e(in_array($type->type, json_decode(auth()->user()->club->types ?? '[]', true)) ? 'checked' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('clubDash.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\frmpas\resources\views/clubDash/pages/compte/index.blade.php ENDPATH**/ ?>