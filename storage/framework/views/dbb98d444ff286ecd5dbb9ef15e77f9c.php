<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="padding-top: 0px;padding-left: 0px;">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="index.html">
        <div class="d-flex align-items-center"><img class="me-2"
                src=<?php echo e(asset('dashboard/img/icons/spot-illustrations/falcon.png')); ?> alt="" width="40" /><span
            ...
            <div class="search-box" data-list='{"valueNames":["title"]}'>
                ...
                <a href=<?php echo e(route('admin.index')); ?>>
                    <div class="d-flex py-3 px-2">
                        <img src=<?php echo e(asset('/images/logo.png')); ?> width="20%" />
                    </div>
                </a>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <hr class="bg-200 dark__bg-900" />
                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Files
                        ...
                        <hr class="bg-200 dark__bg-900" />
                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members
                        </h6><a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l status-online me-2">
                                    <img class="rounded-circle" src=<?php echo e(asset('dashboard/img/team/1.jpg')); ?> alt="" />
                                </div>
                                <div class="flex-1">
                        ...
                        <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src=<?php echo e(asset('dashboard/img/team/2.jpg')); ?> alt="" />
                        ...
                        <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src=<?php echo e(asset('dashboard/img/team/3.jpg')); ?> alt="" />
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                            ...
                            <div class="list-group-item">
                                <a class="notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle"
                                                src=<?php echo e(asset('dashboard/img/icons/weather-sm.jpg')); ?> alt="" />
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                ...
                <div class="avatar avatar-xl d-flex">
                    <img class="rounded-circle" src=<?php echo e($me->image); ?> alt="" />
                </div>
            </a>
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    <span style="color: black" class="ps-2"><?php echo e($me->nom . " " . $me->prenom); ?></span>
...
</nav><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/layout/header.blade.php ENDPATH**/ ?>