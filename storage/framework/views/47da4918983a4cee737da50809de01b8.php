...
<div class="card mb-3">
    <div class="card-body d-flex flex-wrap flex-between-center">
        <div>
            ...
            <h5 class="mb-0"><?php echo e($plongeur->prenom . ' ' . $plongeur->nom); ?>

                (<?php echo e($plongeur->niveau ? $plongeur->niveau->label : ""); ?>)</h5>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/dashboard/pages/plongeur/details.blade.php ENDPATH**/ ?>