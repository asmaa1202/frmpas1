    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                <a href="<?php echo e(route('plongeurs.create')); ?>" role="button" class="btn btn-outline-primary">
                                ...
                                <div class="dropdown font-sans-serif position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-0"
                                        ...
                                        <div class="py-2">
                                            ...
                                            <a class="dropdown-item"
                                               href="/dashboard/plongeurs/<?php echo e($item->id); ?>/carnet-de-plongee">Carnet de plongée
                                            </a>
                                            <a class="dropdown-item"
                                                href="/dashboard/plongeurs/<?php echo e($item->id); ?>/niveau/1/suivi-prepa">Fiche de suivi
                                                prépa
                                            </a>
                                            <a class="dropdown-item"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cdmasoluma/public_html/diver/resources/views/dashboard/pages/plongeur/index.blade.php ENDPATH**/ ?>