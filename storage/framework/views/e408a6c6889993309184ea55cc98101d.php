            ...
            <table id="example" class="table table-bordered data-table table-striped fs--1 mb-0" data-options='{"paging":true,"scrollY":"600px","searching":true,"scrollCollapse":true,"scrollX":true, "language": {
                ...
                <tbody class="list">
                    ...
                    <tr id="row<?php echo e($item->id); ?>">
                        ...
                        <td class="align-middle"><?php echo e($item->lieu); ?></td>
                        <td class="align-middle"><?php echo e($item->creted_at); ?></td>
                        <td class="align-middle"><?php echo e($item->id_directeur); ?></td>
                        <td class="align-middle"><?php echo e($item->id_instructeur); ?></td>
                        <td class="align-middle"><?php echo e($item->site); ?></td>
                        <td class="align-middle"><?php echo e($item->support); ?></td>
                        <td class="align-middle"><?php echo e($item->temps); ?></td>
                        <td class="align-middle"><?php echo e($item->courant); ?></td>
                        <td class="align-middle"><?php echo e($item->visibilite); ?></td>
                        <td class="align-middle"><?php echo e($item->mer); ?></td>
                        <td class="align-middle"><?php echo e($item->t_eau); ?></td>
                        <td class="align-middle"><?php echo e($item->plongee); ?></td>
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item"
                                            href="/dashboard/carnet-plongee/<?php echo e($item->id); ?>/equipes/ajouter">Modifier</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/carnet_plongee/index.blade.php ENDPATH**/ ?>