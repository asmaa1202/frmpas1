...
<title>FRMPAS - Ajouter un athlete</title>
    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                ...
                <a href="<?php echo e(route('athletes.index')); ?>" role="button" class="btn btn-outline-primary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('clubDash.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/clubDash/pages/athletes/ajouter.blade.php ENDPATH**/ ?>