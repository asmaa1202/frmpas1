    ...
    <div class="card-body position-relative">
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-end align-items-center">
                ...
                <a href="<?php echo e(route('carnet_plongee.index')); ?>" role="button" class="btn btn-outline-primary">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-3">
                        ...
                        <select class="form-select js-choice" id="directeur" size="1" name="directeur"
                            ...
                            <option value=<?php echo e($user->id); ?>><?php echo e($user->nom . ' ' . $user->prenom); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/pages/carnet_plongee/ajouter.blade.php ENDPATH**/ ?>