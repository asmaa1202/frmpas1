            ...
            <table id="example" class="table table-bordered data-table table-striped fs--1 mb-0" data-options='{"paging":true,"scrollY":"600px","searching":true,"scrollCollapse":true,"scrollX":true, "language": {
                ...
                <tbody class="list">
                    ...
                    <tr id="row1">
                        ...
                        <td class="align-middle"> 
                            <?php echo $club->has_active_adhesion 
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Êtes-vous sûr de vouloir supprimer le club <strong><?php echo e($club->nom); ?></strong> ?
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\frmpas\resources\views/dashboard/pages/clubs/club.blade.php ENDPATH**/ ?>