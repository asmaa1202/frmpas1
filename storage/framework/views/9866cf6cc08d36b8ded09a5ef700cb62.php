...
<head>
    ...
    <meta name="csrf" content="13K625e8mnDna1oxm9rqjfAPfougtTlYdnfdgfdgdf">
    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    ...
    <link href=<?php echo e(asset('dashboard/vendors/fullcalendar/main.min.css')); ?> rel="stylesheet">
...
<body>
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <?php echo $__env->make('dashboard.layout.slidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="content">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src=<?php echo e(asset('dashboard/img/generic/falcon-mode-dark.jpg')); ?> alt="" /></span><span
                                class="label-text">
                                Dark</span></label>
                    </div>
                </div>
    ...
    <script src=<?php echo e(asset('dashboard/vendors/fullcalendar/main.min.js')); ?>></script>
    <script src=<?php echo e(asset('dashboard/vendors/dayjs/dayjs.min.js')); ?>></script>
...
</html><?php /**PATH C:\Users\CDMA_MOBILE\Desktop\FRMPAS\resources\views/dashboard/layout/master.blade.php ENDPATH**/ ?>