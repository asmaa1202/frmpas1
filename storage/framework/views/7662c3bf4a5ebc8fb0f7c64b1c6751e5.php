    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                ...
                <div class="avatar avatar-xl d-flex">
                    <img class="rounded-circle" src=<?php echo e(asset(Auth::user()->club->image ?? 'dashboard/img/team/avatar.png')); ?> alt="" />
                </div>
            </a>
...
<?php /**PATH C:\xampp\htdocs\frmpas\resources\views/clubDash/layout/header.blade.php ENDPATH**/ ?>