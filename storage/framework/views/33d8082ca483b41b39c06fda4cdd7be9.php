        ...
        <div class="row">
            <div class="<?php echo e(isset($active_licence) ? 'col-lg-6' : 'col-lg-8'); ?>">
                ...
                <div class="d-flex align-items-center">
                    <img class="rounded me-3" src="<?php echo e(Auth::guard('plongeurs')->user()->image); ?>" alt="" width="100">
                  
                    <div class="ms-1 ms-sm-3">
                        <p class="fw-semi-bold mb-3 mb-sm-2 fs-1"><a href="#"><?php echo e(Auth::guard('plongeurs')->user()->nom); ?> <?php echo e(Auth::guard('plongeurs')->user()->prenom); ?></a>
                        ...
                        <div class="row align-items-center gx-0 gy-2">
                            ...
                            <div class="col-auto lh-1 me-3">
                                <?php if(isset($active_licence) && $active_licence->statut == 'accepter'): ?>
                            ...
                            <div class="col-auto">
                                <h6 class=" <?php echo e(now()->month !== 12 ? 'mb-0 text-500' : 'remaining-days-warning'); ?>"><?php echo e($remainingDays); ?> jours restants</h6>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center gx-0 gy-2" style="margin-top:.5px;">
                            <div class="col-auto me-2">
                                <h6 class="client mb-0">
                                        ...
                                        <span><?php echo e(Auth::guard('plongeurs')->user()->club->nom); ?></span>
                                   </h6>
                            </div>
                            <div class="col-auto lh-1 me-3">
                                <?php if(isset($adhesion_club)): ?>
                                    <small class="badge rounded badge-subtle-success false">Actif</small>
                                <?php else: ?>
                                    <small class="badge rounded badge rounded badge-subtle-danger false">Inactif</small>
                                <?php endif; ?>
            ...
            <?php if(isset($active_licence) && $active_licence->statut == 'accepter'): ?>
                 ...
                 <div class="d-flex flex-column justify-content-center align-items-end" style="height: 100%; position: absolute; bottom: 0; right: 0; width: fit-content;">
                    ...
                    <?php if(empty($active_licence_next_year) && now()->month == 12): ?>
                    <div class="mb-2">
                        <button class="btn btn-danger signal-button" data-bs-toggle="modal" data-bs-target="#licenceModal">
                            Demande de licence
                        </button>
                    </div>
                    <?php elseif(isset($active_licence_next_year) && now()->month == 12 && ($active_licence_next_year->statut == 'en cours' || $active_licence_next_year->statut == 'en_cours_validation')): ?>
                    <div class="mb-2">
                    ...
                    <?php endif; ?>
                    <div>
                        <a href="<?php echo e(route('attestation.licence', Auth::guard('plongeurs')->user()->id)); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plongeurDash.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projets\FRMPAS\resources\views/plongeurDash/pages/home.blade.php ENDPATH**/ ?>