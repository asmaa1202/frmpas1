    ...
    var Resumable = function (opts) {
        ...
        var $h = {
            ...
            generateUniqueIdentifier: function (file, event) {
                ...
                var size = file.size;
                return (
                    size + "-" + relativePath.replace(/[^0-9a-zA-Z_-]/gim, "")
                );
            },
        ...
        var appendFilesFromFileList = function (fileList, event) {
            ...
            $h.each(fileList, function (file) {
                ...
                if (
                    typeof o.minFileSize !== "undefined" &&
                ...
                if (
                    typeof o.maxFileSize !== "undefined" &&
                ...
                if (
                    uniqueIdentifier &&
                    typeof uniqueIdentifier.then === "function"
                ) {
        ...
        function ResumableFile(resumableObj, file, uniqueIdentifier) {
            ...
            $.bootstrap = function () {
                ...
                var maxOffset = Math.max(
                    round($.file.size / $.getOpt("chunkSize")),
                    1
                );
                ...
                $h.each($.files, function (file) {
                    ...
                    if (
                        ...
                        file.chunks[file.chunks.length - 1].status() ==
                            "pending" &&
                        file.chunks[file.chunks.length - 1].preprocessState ===
                            0
                    ) {
